...
void print_heap_usage(char *msg)
{
    ...
    WICED_BT_TRACE("Maximum heap utilized so far: %u bytes/%.2f KB, %.2f%% of available heap\r\n",
            mall_info.arena, TO_KB(mall_info.arena), ((float) mall_info.arena * 100u)/heap_size);

    WICED_BT_TRACE("Heap in use at this point   : %u bytes/%.2f KB, %.2f%% of available heap\r\n",
